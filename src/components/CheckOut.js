...
const CheckoutForm = (props) => {
   ...
   console.log('form', {
	...
	const handleSubmit = async (
		event,
		{ programType1, extraServices1, roomNumber1, totalAmount1, stripeKey }
	) => {
		...
		if (!stripe || !elements) {
			// Checkout.js has not loaded yet. Make sure to disable
...
// recreating the `Checkout` object on every render.
